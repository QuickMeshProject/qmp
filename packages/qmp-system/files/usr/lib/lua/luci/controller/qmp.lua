...
function index()
  ...
  entry({"qmp","configuration","gateways"}, cbi("qmp/gateways_search"), "qMp gateways", 50).dependent=false
    entry({"qmp","configuration","gateways","search"}, cbi("qmp/gateways_search"), "Search for gateways", 51).dependent=false
    entry({"qmp","configuration","gateways","offer"}, cbi("qmp/gateways_offer"), "Offer gateways", 52).dependent=false
