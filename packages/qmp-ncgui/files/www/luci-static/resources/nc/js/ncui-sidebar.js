var categories = [  {"id": "system", "name": "Node",
                    ...
                    "subcategories":   [{"id": "neighbours", "name": "Neighbours", "functn": sidebarMeshNeighbours},
                                        ...
                                        {"id": "allbmx7", "name": "Load all BMX7 info", "functn": sidebarMeshAllBmx7},
                    ...
                    {"id": "bmx7", "name": "BMX7",
                     "subcategories":  [{"id": "status", "name": "Status", "functn": sidebarBmx7Status},
                                        {"id": "interfaces", "name": "Interfaces", "functn": sidebarBmx7Interfaces},
                                        {"id": "links", "name": "Links", "functn": sidebarBmx7Links},
                                        {"id": "originators", "name": "Originators", "functn": sidebarBmx7Originators},
                                        {"id": "paths", "name": "Paths", "functn": sidebarBmx7Paths},
                                        {"id": "algorithm", "name": "Algorithm", "functn": sidebarBmx7Algorithm},
                                        {"id": "evaluation", "name": "Algorithms evaluation", "functn": sidebarBmx7Evaluation},
                                        {"id": "metrics", "name": "Metrics (table)", "functn": sidebarBmx7Metrics},
                                        {"id": "matrix", "name": "Metrics (matrix)", "functn": sidebarBmx7Matrix}] },
